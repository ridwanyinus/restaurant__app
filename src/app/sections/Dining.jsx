      ...
      <main className="pt-12 xs:pt-16 lg:pt-24  sm:px-4 md:px-6 lg:px-12 w-full h-full space-y-12 xs:space-y-16  sm:space-y-24 lg:space-y-28 xl:space-y-32">
        ...
        <div className="flex w-full pr-3  xs:px-3 lg:px-0 md:space-x-3 lg:space-x-0 items-start">
          <div className="relative right-0 flex  justify-start h-[110px] xs:h-[120px] sm:h-[150px] md:h-[200px] lg:h-[250px] linear2 ">
            <Image src={dining2} alt="dining" quality={100} className="w-[65%] xs:w-[100%]  object-cover" />
        ...
        <div className="flex justify-end w-full max-sm:pl-3">
          ...
          <div className="relative right-0 flex justify-end h-[110px] xs:h-[120px] sm:h-[150px] md:h-[200px] lg:h-[250px] linear">
            <Image src={dining3} alt="dining" quality={100} className="w-[65%] xs:w-[75%] sm:w-[80%] object-cover" />
            <p className="text-yellow font-display absolute bottom-0 left-[5%] z-10 text-2xl xs:text-3xl sm:text-4xl   md:text-4xl xl:text-6xl 2xl:text-[65px]">$500</p>
          </div>
        </div>
      </main>
